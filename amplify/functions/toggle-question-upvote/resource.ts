...
/**
 * Adds or removes an upvote on an audience question, idempotently.
 *
 ...
 */
export const toggleQuestionUpvote = defineFunction({
  name: 'toggle-question-upvote',
  entry: './handler.ts',
  ...
  environment: {
    POWERTOOLS_SERVICE_NAME: 'toggle-question-upvote',
